// Package codec 实现 beastcli 与 beastserver 之间的字节级协议层。
//
// 必须与 sdk/godot/beast_sdk/impl/codec/*.gd 和 sdk/native/core/include/beast/client/*codec.hpp
// 保持 byte-level 一致，否则不同 SDK 实现的客户端无法与同样的服务端互通。
package codec
