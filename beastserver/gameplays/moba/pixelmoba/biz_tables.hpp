...
inline constexpr const char* kMatchRewardsTableLogicalName = "moba/pixel_moba/match_rewards";
inline constexpr const char* kRecipeTableLogicalName = "moba/pixel_moba/recipe";
