...
#include "beast/platform/engine/ai/ai_observation.hpp"
#include "beast/platform/engine/ai/ai_output_spec.hpp"
#include "beast/platform/engine/ai/ai_receipt_result.hpp"
