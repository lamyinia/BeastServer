...
#include "beast/mixin/ai/ai_relay.hpp"
...
public:
    ...
    void set_ai_facade(InstanceAiFacade* facade) noexcept { ai_facade_ = facade; }
    [[nodiscard]] InstanceAiFacade* ai_facade() noexcept { return ai_facade_; }
...
private:
    ...
    InstanceAiFacade* ai_facade_{nullptr};
